...
public abstract class SystemUiHider {
    ...
    /**
     * This flag is for deciding whether to toggle the status bar in Post-Honeycomb
     * devices. Leave unset for compatibility with Pre-Honeycomb or OR it with
     * one of the other flags to toggle the status bar at the same time as the
     * rest of the UI
     */
    public static final int FLAG_TOGGLE_STATUS_BAR = 0x8;
